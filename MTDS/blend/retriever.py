...
# First Party
from MTDS.blend.interfaces import (
    BlendRetriever,
...
class SPTBlendRetriever(BlendRetriever):
    ...
    Example:
        ...
        Requests sent to MTDS engine when using drop_spt_and_get_indices
        and new_request:
        - [x, x, x]
        - [y, y]
        - [z, z, z, z]
    ...
    def __init__(
        self,
        cache_engine: MTDSEngine,
        metadata: MTDSEngineMetadata,
    ):
        """Initialize the SPT retriever.

        :param MTDSEngine cache_engine: The cache engine to retrieve
            the KV caches
        :param MTDSEngineMetadata metadata: The metadata of the cache engine
        """

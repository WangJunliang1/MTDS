...
from MTDS.v1.cache_controller.controllers import KVController, RegistrationController
from MTDS.v1.cache_controller.executor import MTDSClusterExecutor
from MTDS.v1.cache_controller.rpc_utils import (  # noqa: E501
    get_zmq_context,
    get_zmq_socket,
)

from MTDS.v1.cache_controller.message import (  # isort: skip
    CheckFinishMsg,
    ClearMsg,
    CompressMsg,
    DeRegisterMsg,
...
class MTDSControllerManager:
    def __init__(self, controller_url: str):
        ...
        # Cluster executor
        self.cluster_executor = MTDSClusterExecutor(
            ...
            try:
                ...
                for part in parts:
                    ...
                    if part.startswith(b"{"):
                        ...
                        # MessagePack format - internal MTDS communication

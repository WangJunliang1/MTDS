...
# differentiate among
# (1) WorkerMsg: push-pull (MTDS->controller)
# (2) ControlMessage: req-reply (controller->MTDS)
# (3) OrchMsg: req-reply (ochestrator->controller)
"""Message from MTDS to Controller"""


class WorkerMsg(MsgBase):
    """Message between MTDS and Controller"""
...
"""Control Message from Controller to MTDS"""


class ControlMsg(MsgBase):
    """Message from Controller to MTDS"""
...
class ClearWorkerMsg(ControlMsg):
    """Clear message for a single MTDS worker"""
...
class PinWorkerMsg(ControlMsg):
    """Pin message for a single MTDS worker"""
...
class CompressWorkerMsg(ControlMsg):
    """Compress message for a single MTDS worker"""
...
class MoveWorkerMsg(ControlMsg):
    """Move message for a single MTDS worker"""
...
class HealthWorkerMsg(ControlMsg):
    """Health message for a single MTDS worker"""
...
class CheckFinishWorkerMsg(ControlMsg):
    """Check finish message for a single MTDS worker"""
...
class ControlRetMsg(MsgBase):
    """Return message from MTDS to Controller"""
...
class PinWorkerRetMsg(ControlRetMsg):
    """Pin return message for a single MTDS worker"""
...
class CompressWorkerRetMsg(ControlRetMsg):
    """Compress return message for a single MTDS worker"""
...
class MoveWorkerRetMsg(ControlRetMsg):
    """Move return message for a single MTDS worker"""
...
class HealthWorkerRetMsg(ControlRetMsg):
    """Health return message for a single MTDS worker"""
...
class CheckFinishWorkerRetMsg(ControlRetMsg):
    """Check finish return message for a single MTDS worker"""
...
"""Orchestration Message from Ochestrator to MTDS"""

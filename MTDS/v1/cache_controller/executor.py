...
# NOTE (Jiayi): `MTDSClusterExecutor` might need to be in different processes
...
class MTDSClusterExecutor:
    """
    MTDS Cluster Executor class to handle the execution of cache operations.
    """

    def __init__(self, reg_controller):
        """
        Initialize the MTDS Executor with a cache instance.

        :param MTDS_instance_id: MTDS_instance_id
        """

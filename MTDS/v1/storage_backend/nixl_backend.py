...
from MTDS.v1.storage_backend.connector.nixl_connector_v2 import (
    NixlChannel,
    NixlObserverInterface,
)
from MTDS.v1.storage_backend.connector.nixl_utils import NixlConfig, NixlRole
...
class NixlBackend(StorageBackendInterface):
    ...
    def CreateNixlBackend(
        config: MTDSEngineConfig, metadata: MTDSEngineMetadata
    ) -> "NixlBackend":
        """

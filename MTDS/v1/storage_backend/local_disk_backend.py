...
from MTDS.observability import LMCStatsMonitor
from MTDS.utils import CacheEngineKey, DiskCacheMetadata, _MTDS_nvtx_annotate
from MTDS.v1.cache_controller.message import KVAdmitMsg, KVEvictMsg
from MTDS.v1.config import MTDSEngineConfig
from MTDS.v1.lookup_server import LookupServerInterface
from MTDS.v1.memory_management import MemoryFormat, MemoryObj
from MTDS.v1.storage_backend.abstract_backend import StorageBackendInterface
from MTDS.v1.storage_backend.evictor import LRUEvictor, PutStatus
from MTDS.v1.storage_backend.local_cpu_backend import LocalCPUBackend

if TYPE_CHECKING:
    # First Party
    from MTDS.v1.cache_controller.worker import MTDSWorker
...
class LocalDiskBackend(StorageBackendInterface):
    def __init__(
        ...
        dst_device: str = "cuda",
        MTDS_worker: Optional["MTDSWorker"] = None,
        ...
        self.MTDS_worker = MTDS_worker
        self.instance_id = config.MTDS_instance_id
    ...
    def insert_key(self, key: CacheEngineKey, memory_obj: MemoryObj) -> None:
        ...
        # push kv admit msg
        if self.MTDS_worker is not None and not has_stored:
            self.MTDS_worker.put_msg(

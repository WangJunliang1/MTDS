...
from MTDS.storage_backend.serde.cachegen_basics import (
    CacheGenGPUEncoderOutput,
)
from MTDS.storage_backend.serde.cachegen_decoder import (
    decode_function_gpu,
    do_dequantize,
)
...
from MTDS.v1.storage_backend.naive_serde.cachegen_basics import CacheGenConfig
from MTDS.v1.storage_backend.naive_serde.serde import Deserializer

logger = init_logger(__name__)


class CacheGenDeserializer(Deserializer):
    def __init__(self, config: MTDSEngineConfig, metadata: MTDSEngineMetadata):

...
from MTDS.storage_backend.local_backend import LMCLocalBackend
from MTDS.storage_backend.remote_backend import (
...
class LMCHybridBackend(LMCBackendInterface):
    ...
    def _prefetch(self, metadata: MTDSEngineMetadata):

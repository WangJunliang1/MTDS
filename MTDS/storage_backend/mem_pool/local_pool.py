...
# First Party
from MTDS.config import MTDSMemPoolMetadata
from MTDS.logging import init_logger
from MTDS.storage_backend.mem_pool.base_pool import BasePool, KVObj

logger = init_logger(__name__)


class LocalPool(BasePool):
    def __init__(self, metadata: MTDSMemPoolMetadata):
    ...
    def init_max_chunk_num(self, metadata: MTDSMemPoolMetadata) -> int:
        """

...
from MTDS.storage_backend.serde.cachegen_basics import CacheGenEncoderOutput
...
def test_cachegen_encoder(chunk_size):
    fmt = "vllm"
    fmt2 = "huggingface"
    config = MTDSEngineConfig.from_defaults(chunk_size=chunk_size)

...
# First Party
from MTDS.blend.executor import CacheBlendImpl
from MTDS.blend.retriever import SPTBlendRetriever
...
def dumb_metadata(fmt="vllm", kv_shape=(32, 2, 256, 8, 128)):
    ...
    return MTDSEngineMetadata("test_model", 3, 123, fmt, dtype, kv_shape)
...
def test_spt_full_hit(fmt, autorelease):
    ...
    engine = autorelease(MTDSEngine(cfg, dumb_metadata(fmt)))

...
from MTDS.v1.gpu_connector import VLLMPagedMemGPUConnectorV2
...
def create_config(role: str, host: str, port: int) -> MTDSEngineConfig:
    """Create a configuration for the MTDSEngine with Nixl backend."""
...
def create_metadata() -> MTDSEngineMetadata:
    """Create metadata for the MTDSEngine."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test MTDSEngine with Nixl backend")
    parser.add_argument(
        "--role",
        type=str,
        required=True,
    ...
    # Create the MTDSEngine (will be reused across rounds)
    ...
    MTDSEngineBuilder.destroy("test_engine")
